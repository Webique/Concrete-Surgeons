...
const demolitionServiceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Demolition Services",
  description:
    "Safe, controlled, and precision-engineered demolition services including high-reach demolition, controlled demolition, robotic demolition, and diamond wire sawing.",
  provider: {
    "@type": "Organization",
  ...
  itemListElement: [
    {
      ...
      position: 1,
      name: "Home",
      item: "https://csmisr.com/",
    },
    {
      "@type": "ListItem",
      position: 2,
      name: "Services",
      item: "https://csmisr.com/services",
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Demolition",
      item: "https://csmisr.com/services/demolition",
    },
  ],
};
...
export default function Demolition() {
  ...
  return (
    <>
      <SEO
        title="Demolition Services | High-Reach & Controlled Demolition - Concrete Surgeons"
        description="Expert demolition services including high-reach demolition (up to 27m), controlled demolition, robotic demolition, and diamond wire sawing. OSHA-certified teams in Egypt."
        canonical="/services/demolition"
        jsonLd={[demolitionServiceSchema, breadcrumbSchema]}
      />
      <div
        className={`${
      ...
      >
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <div className="space-y-4">
                  {t("demolition.whatIsList", { returnObjects: true }).map(
                    (item, index) => (
                      <motion.div
                        key={index}
        ...
        <section
          ref={ref1}
          className="relative py-20 sm:py-32 px-4 sm:px-6 lg:px-20 bg-white overflow-hidden"
        >
          {/* Background Pattern */}
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {t("demolition.safetyList", { returnObjects: true }).map(
                    (item, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, y: 20 }}
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <div className="space-y-6">
                  {t("demolition.toolsExtra", { returnObjects: true }).map(
                    (item, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, x: 20 }}
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-12 overflow-hidden">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  ...
                  <div className="space-y-4">
                    {t("demolition.attachmentsList", {
                      ...
                      <motion.div
                        ...
                        className={`flex items-start ${
                          isRTL ? "space-x-reverse space-x-4" : "space-x-4"
                        } p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors`}
                      >
                        <div className="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                          <div className="w-3 h-3 bg-white rounded-full"></div>
                        </div>
                ...
                >
                  {["/neww1.png", "/new2.png", "/new3.png"].map(
                    (src, index) => (
                      <motion.div
                        key={index}
          ...
          <div className="max-w-7xl mx-auto space-y-20">
            ...
            {[
              ...
              >
                ...
                <div
                  className={`${block.reverse ? "lg:order-1" : ""} space-y-6`}
                >
        ...
        <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-20 bg-white">
          <div className="max-w-7xl mx-auto space-y-16">
            ...
            >
              <div className="space-y-6">
                {t("demolition.controlledList", { returnObjects: true }).map(
                  (item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                      ...
                      className={`flex items-start ${
                        isRTL ? "space-x-reverse space-x-4" : "space-x-4"
                      } p-6 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors`}
                    >
                      <div className="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                        <div className="w-3 h-3 bg-white rounded-full"></div>
                      </div>
        ...
        <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-20 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900">
          <div className="max-w-7xl mx-auto space-y-16">
            ...
            >
              <div className="space-y-6">
                {t("demolition.roboticList", { returnObjects: true }).map(
                  (item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                      ...
                      className={`flex items-start ${
                        isRTL ? "space-x-reverse space-x-4" : "space-x-4"
                      } p-6 bg-white/10 rounded-xl border border-white/20 hover:bg-white/20 transition-colors`}
                    >
                      <div className="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                        <div className="w-3 h-3 bg-white rounded-full"></div>
                      </div>
        ...
        <section className="py-20 sm:py-32 px-4 sm:px-6 lg:px-20 bg-gradient-to-br from-gray-50 to-blue-50">
          <div className="max-w-7xl mx-auto space-y-16">
            ...
            >
              <div className="space-y-6">
                {t("demolition.diamondList", { returnObjects: true }).map(
                  (item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                      ...
                      className={`flex items-start ${
                        isRTL ? "space-x-reverse space-x-4" : "space-x-4"
                      } p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow`}
                    >
                      <div className="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mt-1">
                        <div className="w-3 h-3 bg-white rounded-full"></div>
                      </div>
        ...
        <section
          ref={ref3}
          className="py-20 sm:py-32 px-4 sm:px-6 lg:px-20 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 relative overflow-hidden"
        >
          {/* Background Elements */}
          <div className="absolute inset-0">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              >
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  {t("demolition.whyList", { returnObjects: true }).map(
                    (item, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, y: 20 }}
